...
# Unit tests for Marqeta::StoreResponseModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Marqeta::StoreResponseModel do
  let(:instance) { Marqeta::StoreResponseModel.new }

  describe 'test an instance of StoreResponseModel' do
    it 'should create an instance of StoreResponseModel' do
      expect(instance).to be_instance_of(Marqeta::StoreResponseModel)
    end
  end
