...
module Marqeta
  class AdvancedAuthOtherPoi
    attr_accessor :card_presence

    attr_accessor :cardholder_presence
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Marqeta::AdvancedAuthOtherPoi` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Marqeta::AdvancedAuthOtherPoi`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cardholder_presence')
        self.cardholder_presence = attributes[:'cardholder_presence']
      else
        self.cardholder_presence = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cardholder_presence == o.cardholder_presence &&
    ...
    def hash
      [card_presence, cardholder_presence, partial_approval_capable].hash
    end
