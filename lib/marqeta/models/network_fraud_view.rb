...
module Marqeta
  class NetworkFraudView
    ...
    attr_accessor :transaction_risk_score_reason_description
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Marqeta::NetworkFraudView` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Marqeta::NetworkFraudView`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'transaction_risk_score_reason_description')
        self.transaction_risk_score_reason_description = attributes[:'transaction_risk_score_reason_description']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transaction_risk_score_reason_description == o.transaction_risk_score_reason_description &&
    ...
    def hash
      [transaction_risk_score, transaction_risk_score_reason_code, transaction_risk_score_reason_description, account_risk_score, account_risk_score_reason_code].hash
    end
