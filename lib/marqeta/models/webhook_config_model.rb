  ...
  class WebhookConfigModel
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Marqeta::WebhookConfigModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Marqeta::WebhookConfigModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@secret.nil? && @secret.to_s.length > 50
        invalid_properties.push('invalid value for "secret", the character length must be smaller than or equal to 50.')
      end

      if !@secret.nil? && @secret.to_s.length < 20
        invalid_properties.push('invalid value for "secret", the character length must be great than or equal to 20.')
      end
      ...
      if @basic_auth_password.to_s.length > 50
        invalid_properties.push('invalid value for "basic_auth_password", the character length must be smaller than or equal to 50.')
      end
    ...
    def valid?
      ...
      return false if !@secret.nil? && @secret.to_s.length > 50
      return false if !@secret.nil? && @secret.to_s.length < 20
      ...
      return false if @basic_auth_password.to_s.length > 50
    ...
    def secret=(secret)
      ...
      if !secret.nil? && secret.to_s.length < 20
        fail ArgumentError, 'invalid value for "secret", the character length must be great than or equal to 20.'
      end
    ...
    def basic_auth_password=(basic_auth_password)
      ...
      if basic_auth_password.to_s.length > 50
        fail ArgumentError, 'invalid value for "basic_auth_password", the character length must be smaller than or equal to 50.'
      end
    ...
    def hash
      [url, secret, basic_auth_username, basic_auth_password, custom_header, use_mtls].hash
    end
