...
module Marqeta
  class DirectDepositAccountTransitionResponse
    attr_accessor :token
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Marqeta::DirectDepositAccountTransitionResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Marqeta::DirectDepositAccountTransitionResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @account_token.to_s.length > 36
        invalid_properties.push('invalid value for "account_token", the character length must be smaller than or equal to 36.')
      end

      if @account_token.to_s.length < 36
        invalid_properties.push('invalid value for "account_token", the character length must be great than or equal to 36.')
      end
      ...
      if @channel.to_s.length > 10
        invalid_properties.push('invalid value for "channel", the character length must be smaller than or equal to 10.')
      end

      if @channel.to_s.length < 6
        invalid_properties.push('invalid value for "channel", the character length must be great than or equal to 6.')
      end
    ...
    def valid?
      ...
      return false if @account_token.to_s.length > 36
      return false if @account_token.to_s.length < 36
      return false if @state.nil?
      return false if @state.to_s.length > 10
      return false if @state.to_s.length < 6
      return false if @channel.nil?
      return false if @channel.to_s.length > 10
      return false if @channel.to_s.length < 6
      return false if @reason.nil?
      return false if @reason.to_s.length > 255
    ...
    def account_token=(account_token)
      if account_token.nil?
        fail ArgumentError, 'account_token cannot be nil'
      end

      if account_token.to_s.length > 36
        fail ArgumentError, 'invalid value for "account_token", the character length must be smaller than or equal to 36.'
      end

      if account_token.to_s.length < 36
        fail ArgumentError, 'invalid value for "account_token", the character length must be great than or equal to 36.'
      end
    ...
    def channel=(channel)
      ...
      if channel.to_s.length > 10
        fail ArgumentError, 'invalid value for "channel", the character length must be smaller than or equal to 10.'
      end

      if channel.to_s.length < 6
        fail ArgumentError, 'invalid value for "channel", the character length must be great than or equal to 6.'
      end
    ...
    def hash
      [token, user_token, business_token, account_token, state, channel, reason, created_time].hash
    end
