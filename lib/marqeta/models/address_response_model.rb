  ...
  class AddressResponseModel
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Marqeta::AddressResponseModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Marqeta::AddressResponseModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@address1.nil? && @address1.to_s.length > 35
        invalid_properties.push('invalid value for "address1", the character length must be smaller than or equal to 35.')
      end
      ...
      if !@address2.nil? && @address2.to_s.length > 35
        invalid_properties.push('invalid value for "address2", the character length must be smaller than or equal to 35.')
      end
      ...
      if !@state.nil? && @state.to_s.length > 35
        invalid_properties.push('invalid value for "state", the character length must be smaller than or equal to 35.')
      end
    ...
    def valid?
      return false if !@address1.nil? && @address1.to_s.length > 35
      return false if !@address1.nil? && @address1.to_s.length < 0
      return false if !@address2.nil? && @address2.to_s.length > 35
      return false if !@address2.nil? && @address2.to_s.length < 0
      return false if !@city.nil? && @city.to_s.length > 35
      return false if !@city.nil? && @city.to_s.length < 0
      return false if !@state.nil? && @state.to_s.length > 35
    ...
    def address1=(address1)
      if !address1.nil? && address1.to_s.length > 35
        fail ArgumentError, 'invalid value for "address1", the character length must be smaller than or equal to 35.'
      end
    ...
    def address2=(address2)
      if !address2.nil? && address2.to_s.length > 35
        fail ArgumentError, 'invalid value for "address2", the character length must be smaller than or equal to 35.'
      end
    ...
    def state=(state)
      if !state.nil? && state.to_s.length > 35
        fail ArgumentError, 'invalid value for "state", the character length must be smaller than or equal to 35.'
      end
    ...
    def hash
      [address1, address2, city, state, zip, postal_code, country].hash
    end
