...
module Marqeta
  class PushToCardDisburseRequest
    attr_accessor :tags
    ...
    attr_accessor :payment_instrument_token
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Marqeta::PushToCardDisburseRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Marqeta::PushToCardDisburseRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payment_instrument_token')
        self.payment_instrument_token = attributes[:'payment_instrument_token']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @amount > 5E+4
        invalid_properties.push('invalid value for "amount", must be smaller than or equal to 5E+4.')
      end
      ...
      if @payment_instrument_token.nil?
        invalid_properties.push('invalid value for "payment_instrument_token", payment_instrument_token cannot be nil.')
      end

      if @payment_instrument_token.to_s.length > 36
        invalid_properties.push('invalid value for "payment_instrument_token", the character length must be smaller than or equal to 36.')
      end

      if @payment_instrument_token.to_s.length < 1
        invalid_properties.push('invalid value for "payment_instrument_token", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @amount > 5E+4
      return false if @amount < 0.01
      return false if @payment_instrument_token.nil?
      return false if @payment_instrument_token.to_s.length > 36
      return false if @payment_instrument_token.to_s.length < 1
      true
    end
    ...
    def amount=(amount)
      ...
      if amount > 5E+4
        fail ArgumentError, 'invalid value for "amount", must be smaller than or equal to 5E+4.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] payment_instrument_token Value to be assigned
    def payment_instrument_token=(payment_instrument_token)
      if payment_instrument_token.nil?
        fail ArgumentError, 'payment_instrument_token cannot be nil'
      end

      if payment_instrument_token.to_s.length > 36
        fail ArgumentError, 'invalid value for "payment_instrument_token", the character length must be smaller than or equal to 36.'
      end

      if payment_instrument_token.to_s.length < 1
        fail ArgumentError, 'invalid value for "payment_instrument_token", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amount == o.amount &&
          payment_instrument_token == o.payment_instrument_token
    end
    ...
    def hash
      [tags, memo, token, currency_code, amount, payment_instrument_token].hash
    end
