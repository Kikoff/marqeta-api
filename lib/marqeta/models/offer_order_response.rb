...
module Marqeta
  class OfferOrderResponse
    ...
    attr_accessor :order_aggregated_balances
    ...
    def self.attribute_map
      {
        ...
        :'order_aggregated_balances' => :'order_aggregated_balances',
        :'funding' => :'funding',
        :'offer' => :'offer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Marqeta::OfferOrderResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Marqeta::OfferOrderResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'order_aggregated_balances')
        self.order_aggregated_balances = attributes[:'order_aggregated_balances']
      end
    ...
    def list_invalid_properties
      ...
      if @order_aggregated_balances.nil?
        invalid_properties.push('invalid value for "order_aggregated_balances", order_aggregated_balances cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @order_aggregated_balances.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          order_aggregated_balances == o.order_aggregated_balances &&
          funding == o.funding &&
          offer == o.offer &&
    ...
    def hash
      [created_time, last_modified_time, user_token, business_token, token, order_balances, order_aggregated_balances, funding, offer, last_transaction_date].hash
    end
