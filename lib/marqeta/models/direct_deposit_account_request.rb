...
module Marqeta
  class DirectDepositAccountRequest
    ...
    attr_accessor :customer_due_diligence
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Marqeta::DirectDepositAccountRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Marqeta::DirectDepositAccountRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'customer_due_diligence')
        if (value = attributes[:'customer_due_diligence']).is_a?(Array)
          self.customer_due_diligence = value
        end
      end
    end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["DEPOSIT_ACCOUNT", "CHECKING", "SAVINGS"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["DEPOSIT_ACCOUNT", "CHECKING", "SAVINGS"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          token == o.token &&
          customer_due_diligence == o.customer_due_diligence
    end
    ...
    def hash
      [user_token, business_token, type, allow_immediate_credit, token, customer_due_diligence].hash
    end
