  ...
  class DepositDepositResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Marqeta::DepositDepositResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Marqeta::DepositDepositResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'state_reason_code')
        self.state_reason_code = attributes[:'state_reason_code']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          state_reason_code == o.state_reason_code &&
    ...
    def hash
      [token, amount, type, state, settlement_date, state_reason, state_reason_code, direct_deposit_account_token, user_token, business_token, created_time, last_modified_time, standard_entry_class_code, company_name, company_discretionary_data, company_identification, company_entry_description, individual_identification_number, individual_name].hash
    end
